...
public class SDLActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (Environment.MEDIA_MOUNTED.equals(Environment
            ...
            config.autoSelectLanguage(this);
    ...
    private void extractFiles(final SharedPreferences preferences) {
        ...
        final Utility.UnzipTask unzipTask = new Utility.UnzipTask(config.getOriginalFilesPath() + "/") {
            ...
            protected void onPostExecute(AsyncTaskResult<String> result) {
                ...
                if ((error = result.getError()) != null) {
                    ...
                    if (error instanceof IOException
                        ...
                        DialogFactory.createNotEnoughSpaceDialog(SDLActivity.this).show();
                    } else {
        ...
        AsyncTask<String, Void, AsyncTaskResult<File>> copyTask = new AsyncTask<String, Void, AsyncTaskResult<File>>() {
            ...
            protected AsyncTaskResult<File> doInBackground(String... params) {
                ...
                try {
                    Utility.copyAsset(SDLActivity.this, params[0], params[1]);
                } catch (IOException e) {
            ...
            protected void onPreExecute() {
                ...
                spinner.setMessage(getString(R.string.copy_process));
        ...
        /*InputStream is = null;
        try{
            is = getAssets().open("th.zip");
        } catch (IOException e) {
            e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
        }
        Utility.UnzipStreamTask unzipStreamTask = new Utility.UnzipStreamTask(config.getOriginalFilesPath() + "/") {
            @Override
            protected void onPreExecute() {
                super.onPreExecute();
	...
	private void installFiles(final SharedPreferences preferences) {
		final ProgressDialog dialog = new ProgressDialog(this);
        final ProgressDialog spinner = new ProgressDialog(this);
		final Utility.UnzipTask unzipTask = new Utility.UnzipTask(dataRoot + "/scripts/") {
        ...
        /*InputStream is = null;
        try{
            // TODO: InputStream will be leaked!
            is = getAssets().open("game.zip");
        } catch (IOException e) {
            e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
        }
        Utility.UnzipStreamTask unzipStreamTask = new Utility.UnzipStreamTask(dataRoot + "/scripts/") {
            @Override
            protected void onPreExecute() {
                super.onPreExecute();
                dialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menuitem_setup:
			...
			builder.setMessage(getResources().getString(R.string.reselect_device_tips))
    ...
    private void reselectDeviceType() {
        SharedPreferences preferences = getSharedPreferences("config", MODE_PRIVATE);
        Editor editor = preferences.edit();
        editor.putBoolean("select_device_type", true);
        editor.commit();
    }
}
