...
public class Configuration {
	...
	public void saveToPreferences(Context ctx, SharedPreferences preferences) {
        ...
        editor.putBoolean("select_device_type", false);
        editor.putString("devicetype_pref", mDeviceType);
		editor.commit();
	...
	public static Configuration loadFromPreferences(Context ctx,
        ...
        if (null != externalFilesDir) {
            ...
            defaultCthPath = "/sdcard/Android/data/com.dreamdance.th/files";
        }
        config.originalFilesPath = preferences.getString("originalfiles_pref",
                defaultCthPath + "/th");
        config.cthPath = preferences.getString("gamescripts_pref", defaultCthPath);
        ...
        config.mDeviceType = preferences.getString("devicetype_pref", "");
    ...
    public void selectConfigForPhone() {
        resolutionMode = 1;
        mDeviceType = "Phone";
    }

    public void selectConfigForPad() {
        resolutionMode = 2;
        mDeviceType = "Pad";
    }

    public void autoSelectLanguage(Context context) {
        String systemLanguage = context.getString(R.string.language);
